...
public class LRUCache extends LinkedHashMap<Integer, Integer> {
    ...
    public LRUCache(int capacity) {
        ...
        In insertion-ordered linked hash maps, merely changing the value associated with a key that is
        ...
        Note: accessOrder:true is very important for us to implement the LRU
         */
